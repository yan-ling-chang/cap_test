...
def get_content(driver, file):
    try:
        ...
        article = driver.find_element(By.XPATH, "//*[@id=\"node-159391\"]/div/div/div/div[3]/div/div")
...
def main(): #初始設定
    ...
    driver.get("https://www.ithome.com.tw/news/159391")
    time.sleep(3)
    
    with open("output_b.txt", "w", encoding="utf-8") as file:
